...
const STRINGS = {
  en: {
    ...
    paymentRefPlaceholder:'Payment reference / transaction ID (required)',
    additionalNotePlaceholder:'Any additional note',
    attachScreenshotHint:'📸 Tap to attach payment screenshot',
    recommendedHint: '(recommended)',
    submitRequestBtn:'📤 Submit Request',
    selectPlanLabel: 'Select plan',
    renewBtnLabel:   '🔄 Submit Renewal Request',
    renewingCurrentPlan:'Renewing your current {plan} plan',
    renewSectionTitle:'🔄 Renew Plan',
    upgradeBtnLabel: '📤 Submit Upgrade Request',
    upgradingFromTo: 'Upgrading from {from} → {to}',
    upgradeSectionTitle:'📦 Upgrade Plan',
    planUpgradeSectionTitle:'📦 Plan & Upgrade',
    addBusinessBtn:  '🏪 Register Your Business',
    orSeparator:     '— or —',
    browseDirectory: '🔍 Browse Shops Directory',
  ...
  ur: {
    appName:        'سف کیو',
    appTagline:     'آپ کا سمارٹ قطار پارٹنر',
    langSwitch:     'English',
    ...
    openingHoursLabel:'کھلنے کا وقت',
    descriptionLabel:'تفصیل',
    descriptionPlaceholder:'اپنے بزنس کی مختصر تفصیل',
    saveProfileBtn:  'پروفائل محفوظ کریں',
    paymentRefPlaceholder:'ادائیگی کا حوالہ / ٹرانزیکشن آئی ڈی (ضروری)',
    additionalNotePlaceholder:'کوئی اضافی نوٹ',
    attachScreenshotHint:'📸 پیمنٹ اسکرین شاٹ اپلوڈ کرنے کے لیے ٹیپ کریں',
    recommendedHint: '(تجویز کردہ)',
    submitRequestBtn:'📤 درخواست جمع کریں',
    selectPlanLabel: 'پلان منتخب کریں',
    renewBtnLabel:   '🔄 تجدید کی درخواست جمع کریں',
    renewingCurrentPlan:'آپ کا موجودہ {plan} پلان تجدید ہو رہا ہے',
    renewSectionTitle:'🔄 پلان کی تجدید',
    upgradeBtnLabel: '📤 اپگریڈ درخواست جمع کریں',
    upgradingFromTo: '{from} سے {to} میں اپگریڈ ہو رہا ہے',
    upgradeSectionTitle:'📦 پلان اپگریڈ کریں',
    planUpgradeSectionTitle:'📦 پلان اور اپگریڈ',
    addBusinessBtn:  '🏪 اپنا بزنس رجسٹر کریں',
    orSeparator:     '— یا —',
    browseDirectory: '🔍 دکانوں کی فہرست دیکھیں',
    claimThisBusiness:'✋ یہ بزنس کلیم کریں',
    unclaimedBadge:  'غیر دعویٰ شدہ',
    viewBusinessPage:'🌐 بزنس صفحہ دیکھیں',
